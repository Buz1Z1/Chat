...
namespace Client
{
    public partial class ChatForm : Form
    {
        ...
        private string _host = "192.168.235.49"; // IP
        private int _port = 27015; // порт
        public ChatForm()
        {
            InitializeComponent();
        ...
        public void handleCommand(string cmd)
        {
                ...
                try
                {
                    ...
                    if(currentCommand.Contains("gfile")) // файлы 
                    {
                        ...
                        DialogResult Result = MessageBox.Show($"Вы хотите принять файл {fileName} размером {FileSize} от {FromName}","Файл",MessageBoxButtons.YesNo); // увидоление при отправке файла
                        if (Result == DialogResult.Yes) // если нажали да то нам отправитс фаил
                        {
